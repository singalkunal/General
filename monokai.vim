...
" editor
call s:h("Normal",        { "fg": s:white,      "bg": s:lightblack })
...
" call s:h("MatchParen",    { "fg": s:darkblack, "bg": s:purple           ,"format": "bold" })
...
" statusline
call s:h("StatusLine",    { "fg": s:darkblack,      "bg": s:white,    "format": "bold" })
" call s:h("StatusLineNC",  { "fg": s:lightgrey,  "bg": s:white })
" call s:h("TabLine",       { "fg": s:lightgrey,  "bg": s:white })
" call s:h("TabLineSel",    { "fg": s:darkblack,  "bg": s:warmgrey,     "format": "bold" })
" call s:h("TbLineFill",   { "fg": s:white,     "bg": s:lightblack })
" call s:h("User1",         { "fg": s:white,     "bg": s:lightgrey,    "format": "bold" })
...
call s:h("StatusLineNC",  { "fg": s:white,  "bg": s:black })
call s:h("TabLine",       { "fg": s:lightgrey,  "bg": s:lightblack })
call s:h("TabLineSel",    { "fg": s:darkblack,  "bg": s:warmgrey,     "format": "bold" })
call s:h("TabLineFill",   { "bg": s:lightblack })
call s:h("User1",         { "fg": s:black,     "bg": s:lightgreen,    "format": "bold" })
call s:h("User2",         { "fg": s:orange,     "bg": s:lightgrey,    "format": "bold" })
call s:h("User3",         { "fg": s:purple,     "bg": s:lightgrey,    "format": "bold" })
call s:h("User4",         { "fg": s:white,       "bg": s:lightgrey,    "format": "bold" })

" spell
call s:h("SpellBad",      { "fg": s:mistyrose,                        "format": "reverse,bold" })
...
call s:h("Comment",       { "fg": s:grey244, "format": "italic" })
...
" call s:h("cDefine",                     { "fg": s:lightgreen})
call s:h("cDefine",                     { "fg": s:white})
